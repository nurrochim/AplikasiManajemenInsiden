class AnalyzingIncidentListController {
    constructor($scope, $state, $compile, DTOptionsBuilder, DTColumnBuilder, API, AclService, ContextService) {
        ...
        ContextService.me(function (data) {
            ...
            if (data) {
                analyzingIcident.params = { idUser: analyzingIcident.userData.id, task: "Analyzing" };
                generateDataTable();
            }
        })
        ...
        let actionsHtml = (data) => {
            return `
                        ...
                        <a class="btn btn-xs btn-warning" ui-sref="app.analyzingForm({issueId: ${data.idIncident}})" uib-tooltip="Edit">
...
export const AnalyzingIncidentListComponent = {
    templateUrl: './views/app/components/analyzing-incident-list/analyzing-incident-list.component.html',
    controller: AnalyzingIncidentListController,
    controllerAs: 'vm',
    bindings: {}
};
