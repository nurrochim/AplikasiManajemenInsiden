    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td class="header-lg">
              Welcome to FID|Manajemen Issue
            </td>
          </tr>
          <tr>
            <td class="free-text">
              Thank you for signing up to FID|Manajemen Issue! We hope you enjoy your time with us. Please confirm your email by clicking the link below.
            </td>
          </tr>
          <tr>
            <td class="button">
        ...
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td style="padding: 25px 0 25px">
              <strong>Fujitsu Indonesia</strong><br />
              Gedung Prince Keiai Jl. Jend. Sudirman Kav. 43<br />
