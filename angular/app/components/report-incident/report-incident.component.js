class ReportIncidentController {
    constructor ($scope, $log) {
        ...
        // pie charts monthly category root cause
        ...
        // pie charts monthly category division
        $scope.labelsPieChartsDivision = ['Credit Analyst', 'Finance', 'General Affairs', 'IT SPD', 'Marketing', 'Collection', 'All'];
        $scope.dataPieChartsDivision = [3, 30, 2, 20, 15, 10, 25]
...
export const ReportIncidentComponent = {
    templateUrl: './views/app/components/report-incident/report-incident.component.html',
